...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SendFilesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Bir döküman seçin");
                ...
                builder.setItems(options, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which == 0)
                        {
                            ...
                            startActivityForResult(intent.createChooser(intent, "Fotoğraf Seçin"), 438);
                        }
                        if (which == 1)
                        {
                            checker = "pdf";
                            ...
                            startActivityForResult(intent.createChooser(intent, "Lütfen bir PDF dosyası seçin"), 438);
                        }
                        if (which == 2)
                        {
                            checker = "docx";
                            ...
                            startActivityForResult(intent.createChooser(intent, "Lütfen bir Ms Word dosyası seçin"), 438);
                        }
                    }
                });
                builder.show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode==438 && resultCode==RESULT_OK && data!=null && data.getData()!=null)
        {
            ...
            {
                Toast.makeText(this, "Hiçbir şey seçilmedi, Hata.", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void SendMessage()
    {
        ...
        {
            Toast.makeText(this, "İlk Önce Göndermek İstediğin Mesajı Yazman Gerek!", Toast.LENGTH_SHORT).show();
        }
        else
        {
